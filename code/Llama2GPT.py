...
tokenizer_path = os.path.join(current_path, "model/Llama-2-7b-hf/")

tokenizer_Llama = AutoTokenizer.from_pretrained(tokenizer_path, use_fast=True, trust_remote_code=True)
model_Llama = None
